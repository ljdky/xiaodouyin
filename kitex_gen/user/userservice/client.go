...
type Client interface {
	AuthUser(ctx context.Context, Req *user.AuthRequest, callOptions ...callopt.Option) (r *user.AuthResp, err error)
...
func (p *kUserServiceClient) AuthUser(ctx context.Context, Req *user.AuthRequest, callOptions ...callopt.Option) (r *user.AuthResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.AuthUser(ctx, Req)
}
